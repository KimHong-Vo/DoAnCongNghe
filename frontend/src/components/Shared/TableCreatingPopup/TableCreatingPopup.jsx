...
import {Popover, Button, IconButton, FormControl, NativeSelect, Select,Box, MenuItem, InputLabel} from '@mui/material';
          ...
          <div className={Styles.bodyTableCreatingPopup}>
            <div className={Styles.prototypeBackground}>
              <div className={Styles.backgroundImgPrototype}>
                <img src="https://a.trellocdn.com/prgb/dist/images/board-preview-skeleton.14cda5dc635d1f13bc48.svg" alt="" role="presentation"></img>
              </div>
            </div>
            ...
            <form>
              <div className="TittleTable">
                <label className={Styles.titleTable}>
                  ...
                  <input className={Styles.inputField} type="text" spellCheck="off">
                  </input>
                </label>
              </div>
              <div className={Styles.notification}>
                <span role="img" aria-label="wave" className={Styles.notificationIcon}>👋</span>
              ...
              <p className={Styles.notificationText}>
                Không gian làm việc này còn 10 bảng. Các Không gian làm việc miễn phí chỉ có thể có 10 bảng mở. Để có bảng không giới hạn, hãy nâng cấp Không gian làm việc của bạn.
              </p>
              <div className="StartToTryFree">
                  <button className={Styles.buttonStartToTryFree}>
                    ...
                    <div className={Styles.textOfStartToTryFree}>Bắt đầu dùng thử miễn phí</div>
                  </button>
              </div>
